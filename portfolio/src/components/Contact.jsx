      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <motion.form
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-xl space-y-6"
          >
            <input
              type="text"
              name="name"
              ...
              required
              className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 outline-none focus:border-purple-500 transition"
            />
            ...
            <textarea
              ...
              required
              className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 outline-none focus:border-purple-500 transition resize-none"
            ></textarea>
